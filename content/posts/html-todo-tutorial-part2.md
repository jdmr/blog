...
{{< gist jdmr f15700200d0043977e05ac540c4acc68 >}}

We solved it by adding another div for the success message and CSS rules to style it as well as adding the listener to the **ul**. On our [next part we'll look into transitions and animations]({{< ref "html-todo-tutorial-part3.md" >}}).